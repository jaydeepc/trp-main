...
const RFQPreview: React.FC<RFQPreviewProps> = ({
  onNext,
  onCancel,
  bomData = []
}) => {
      ...
      <Card size="large">
        ...
        <div className="bg-gradient-to-r from-primary-blue to-accent-teal text-white rounded-xl p-6 mb-8">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-2xl font-bold">RFQ-2024-001</h1>
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-medium-gray">
                    BOM Analysis • Processed with AI mode
                  </p>
                </div>
              </div>
            </Card>
          ...
          <div className="modal-content">
            <div className="text-center">
              ...
              <p className="text-medium-gray mb-6">
                Your Smart RFQ <strong>RFQ-2024-001</strong> has been sent to suppliers.
