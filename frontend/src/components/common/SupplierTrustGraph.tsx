      ...
      <div className="p-6 pb-0">
          ...
          <div className="flex items-center space-x-3">
            <div className="flex items-center space-x-2">
              ...
              <select
                ...
                className="text-sm border border-surface-200 rounded-xl px-3 py-2 bg-white focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent font-medium"
              >
                <option value="all">All Suppliers (200)</option>
                <option value="trusted">Trusted ({categoryStats.trusted})</option>
                <option value="empanelled">Empanelled ({categoryStats.empanelled})</option>
                <option value="new">New ({categoryStats.new})</option>
              </select>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
          <div className="space-y-4">
            <h4 className="font-semibold text-surface-900 text-sm">Supplier Categories</h4>
            <div className="grid grid-cols-3 gap-3">
              {[
                { category: 'trusted', label: 'Trusted', icon: Award, count: categoryStats.trusted },
                { category: 'empanelled', label: 'Empanelled', icon: Shield, count: categoryStats.empanelled },
                { category: 'new', label: 'New', icon: Zap, count: categoryStats.new }
              ].map(({ category, label, icon: Icon, count }) => (
                <div key={category} className="flex items-center space-x-3 p-3 bg-surface-50 rounded-xl">
                  <div className={`w-8 h-8 bg-gradient-to-br ${getSupplierGradient(category)} rounded-lg flex items-center justify-center`}>
          ...
          <div className="space-y-4">
            <h4 className="font-semibold text-surface-900 text-sm">Market Insights</h4>
                ...
                <div className="flex items-center space-x-3 mb-3">
                  ...
                  <div>
                    ...
                    <span className={`px-2 py-1 rounded-full text-xs font-medium ${
                      hoveredSupplier.category === 'trusted' ? 'bg-primary-100 text-primary-700' :
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className={`text-xs font-medium ${
                      hoveredSupplier.riskLevel === 'Low' ? 'text-emerald-600' :
