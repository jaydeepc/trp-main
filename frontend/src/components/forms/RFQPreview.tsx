...
// import { Send, Edit, FileText, Clock, MapPin, CreditCard, Shield, CheckCircle, AlertTriangle, TrendingUp, Users, Star, Award, Globe, Calendar, Download } from 'lucide-react';
...
//     try {
//       await updateStep(rfq.rfqId, 4, { action: 'send' });
...
//             <div>
//               <h1 className="text-2xl font-bold">{rfq.rfqId}</h1>
...
//                 Your Smart RFQ <strong>{rfq.rfqId}</strong> has been sent to suppliers.
